...
(package `com.miHoYo.GenshinImpact`, version `7.0.1`, versionCode 1234). It loads
...
The public Mesa 25.0.7 build reached a responsive account-login screen on real
Switch hardware with the 6.7.0 (versionCode 1206) and 7.0.0 (versionCode 1224)
Android clients. The 7.0.1 client's binary RVAs and fingerprints are statically
revalidated on the `client-1234` branch, but hardware verification is still
pending. This is not a playable port: later game startup remains experimental.
